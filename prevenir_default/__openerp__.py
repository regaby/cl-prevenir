...

{
    ...
    'version': '8.0.0.0.0',
    'category': 'Tools',
    'summary': "Customization prevenir",
    'author': "Ing. Gabriela Rivero",
    'website': 'http://github.com/regaby/cl-prevenir',
    'license': 'AGPL-3',
    'depends': [
        # basic applications
        'base',
    ...
    'git-repos': [
        'https://github.com/regaby/cl-prevenir.git',
        'https://github.com/regaby/huerta-grafica.git -b 8.0-no-aeroo',
